...
class GeoUtilsTest {
    ...
    void zeroDistance() {
        double d = GeoUtils.distanceMeters(-20.4350, -41.7920, -20.4350, -41.7920);
    ...
    void oneDegreeLongitude() {
        double d = GeoUtils.distanceMeters(-20.4350, -41.7920, -20.4350, -41.7820);
    ...
    void oneDegreeLatitude() {
        double d = GeoUtils.distanceMeters(-20.0, -41.0, -21.0, -41.0);
